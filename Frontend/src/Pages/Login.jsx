    ...
    return (
        <div className="relative h-screen w-full bg-cover bg-center flex items-center justify-center p-4" style={{ backgroundImage: `url(/images/header3.jpg)` }}>
            <div className="w-full max-w-lg bg-black bg-opacity-50 p-8 rounded-lg shadow-2xl">
                ...
                <div>
                    <button className="flex items-center justify-center w-full mt-4 px-6 py-3 text-white font-semibold rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 transition border" onClick={()=>window.open("/api/v1/auth/google", "_self")}>
